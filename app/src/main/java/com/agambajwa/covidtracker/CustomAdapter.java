...
public class CustomAdapter extends ArrayAdapter<CountryModel> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        tvCountryName.setText(countryModelListFiltered.get(position).getCountryName());
        Glide.with(context).load(countryModelListFiltered.get(position).getCountryFlag()).into(ivCountryFlag);
